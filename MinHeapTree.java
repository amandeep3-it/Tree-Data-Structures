...
public class MinHeapTree<V extends Comparable<V>, D> {
	...
	*/
	...
	public MinHeapTree() { this.heap = new ArrayList<Node<V, D>>(); }

	public MinHeapTree(V... values) {
	...
	*/
	...
	public synchronized boolean removeMin() {
